                    ...
                    <SafeAreaView>
                        ...
                        <View style={{ paddingHorizontal: 25, justifyContent: "center", height: "100%", paddingBottom: 200 }}>
                            ...
                            <View style={{ width: "100%", flexDirection: "row", justifyContent: "space-between", paddingTop: 20 }}>
                                <Icons name={"shuffle"} color={activeColors.hue12} size={24} />
                                <Icons name={"repeat"} color={activeColors.hue12} size={24} />
                                <Icons name={"like"} color={activeColors.hue12} size={24} />
                            </View>

                            <View style={{ paddingVertical: 20 }}>
                                <View style={{ width: "100%", height: 8, backgroundColor: activeColors.hue11, borderRadius: 4 }}></View>
                                <View style={{ width: "100%", justifyContent: "space-between", flexDirection: "row", paddingTop: 20 }}>
                                    <Text style={{ fontSize: 12, color: activeColors.hue11, fontWeight: "500" }}>0:00</Text>
                                    <Text style={{ fontSize: 12, color: activeColors.hue11, fontWeight: "500" }}>2:39</Text>
                                </View>
                            </View>

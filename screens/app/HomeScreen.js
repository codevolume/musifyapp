...
const HomeScreen = () => {
    ...
    const category = require("../../categoryData.json");
                    ...
                    <View style={{ height: "100%", backgroundColor: "#f9f9f9" }}>
                        <ScrollView style={{ flex: 1, marginBottom: currentTrack ? 285 : 200 }} showsVerticalScrollIndicator={false}>
                            <View style={{ paddingTop: 25, gap: 16 }}>
                                <FlatList contentContainerStyle={{ paddingHorizontal: 25 }} horizontal={true} keyExtractor={(item, index) => index.toString()} showsHorizontalScrollIndicator={false} data={category} renderItem={({ categoryItem }) => <CategoryItem item={categoryItem} />} />
                            </View>
                    ...
                    <View style={{ flex: 1, backgroundColor: "#f0f0f0" }}>
                        <SafeAreaView>
                            ...
                            <View style={{ alignItems: "center", paddingTop: 40 }}>
                                ...
                                <Text style={{ fontSize: 24, fontWeight: "bold", color: "#202020", paddingTop: 20 }}>Szilveszter</Text>
                            </View>

                            <View style={{ paddingHorizontal: 25, paddingTop: 40, gap: 35 }}>
                                <View style={{ gap: 18 }}>
                                    <Text style={{ fontSize: 20, fontWeight: "bold", color: "#202020" }}>Általános</Text>
                                    <View style={{ gap: 18 }}>
                                        <Pressable>
                                ...
                                <View style={{ gap: 18 }}>
                                    <Text style={{ fontSize: 20, fontWeight: "bold", color: "#202020" }}>Biztonság</Text>
                                    <View style={{ gap: 18 }}>
                                        <Pressable>
                                            <View style={{ backgroundColor: "white", width: "100%", paddingVertical: 16, paddingHorizontal: 16, borderRadius: 6, flexDirection: "row", alignItems: "center", gap: 16 }}>
                                                <Svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">

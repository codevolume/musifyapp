        ...
        <>
            <View style={{ flex: 1, backgroundColor: "white" }}>
                <SafeAreaView>
                    ...
                    <ScrollView style={{ height: "100%", backgroundColor: "#f9f9f9" }}>
                        <View style={{ paddingTop: 25, gap: 16 }}>
                            <FlatList contentContainerStyle={{ paddingHorizontal: 25 }} horizontal={true} showsHorizontalScrollIndicator={false} data={category} renderItem={({ categoryItem }) => <CategoryItem item={categoryItem} />} />
                        </View>
